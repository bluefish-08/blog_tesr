    ...
    var action = {
        ...
        buttons: function () {
            ...
            elements.info.onclick = function () {
                window.open(prop.content.link || "https://www.ddsiot.cn/archives/329.html");
            };
...
if (window.console && window.console.log) {
    console.log("%c Pio %c https://www.ddsiot.cn ", "color: #fff; margin: 1em 0; padding: 5px 0; background: #673ab7;", "margin: 1em 0; padding: 5px 0; background: #efefef;");
}
